  ...
  return (
    <div className="store-locator">
      ...
      <section>
        ...
        <ul>
          <li><strong>Lagos:</strong> 123 Victoria Island, Lagos, Nigeria</li>
          <li><strong>Abuja:</strong> 45 Maitama Crescent, Abuja</li>
          <li><strong>Port Harcourt:</strong> 78 Trans-Amadi Road, Port Harcourt</li>
        </ul>
      </section>
